package pl.edu.agh.ki.lab.to.yourflights.controller.reservations;
...
public class AddReservationController {
    ...
    @FXML
    private JFXButton buttonDeleteTicketOrder, errorField;
    ...
    public void handleSubmitButtonAction(ActionEvent actionEvent) {
        ...
        if(reservation == null) {
            ...
            reservation = new Reservation(LocalDate.now().format(DateTimeFormatter.ofPattern("dd/MM/yyyy")),
    ...
    public AddReservationController(NavigationController navigationController,
